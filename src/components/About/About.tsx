		...
		<section className=' flex flex-col overflow-x-clip  lg:px-20 '>
			...
			<div className=' flex flex-col items-center lg:flex-row'>
				...
				<div className='z-10 p-5 grid grid-cols-1 md:grid-cols-2 gap-5 lg:flex-1 '>
					...
					<p className='text-xl   rounded-lg  p-5 lg:p-0 lg:col-span-2'>
					...
					<p className=' text-xl  rounded-lg  p-5 lg:col-span-2 lg:text-2xl'>
					...
					<p className='px-5 md:col-span-2 text-xl lg:p-0'>
